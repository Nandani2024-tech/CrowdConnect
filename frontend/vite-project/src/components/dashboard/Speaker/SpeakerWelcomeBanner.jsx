  ...
  <div className="bg-gradient-to-r from-purple-600 to-blue-500 rounded-lg p-6 mb-6 text-white shadow-lg">
    ...
    <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mt-6">
      <div className="bg-white/10 rounded-lg p-4">
        ...
        <div className="text-3xl font-bold">{speaker.stats.sessions}</div>
      </div>
      <div className="bg-white/10 rounded-lg p-4">
        <div className="flex items-center gap-2 mb-2">
        ...
        <div className="text-3xl font-bold">{speaker.stats.attendees}</div>
      </div>
      <div className="bg-white/10 rounded-lg p-4">
        <div className="flex items-center gap-2 mb-2">
        ...
        <div className="text-3xl font-bold">{speaker.stats.avgRating} ★</div>
      </div>
      <div className="bg-white/10 rounded-lg p-4">
        <div className="flex items-center gap-2 mb-2">
